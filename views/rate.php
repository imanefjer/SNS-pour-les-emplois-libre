...
<form  method="post" action="" >
  ...
  <input class="btn btn-primary btni"  style="background-color:black; border:none; margin-left:40%" type="submit" name="submit" value="Submit Review">
...
if(isset($_POST['submit'])){
    if(!empty($_POST['rating'])) {
        ...
        $date_reviewed = date('m-d-Y ', time());
        
        $query= "INSERT INTO ReVIEWS (user_id, artisan_id, rating, review_text, date_reviewed)
        VALUES ('$user_id', '$artisan_id', '$rating', '$review_text', '$date_reviewed');";
        if ($conn->query($query) === TRUE) {
            
            echo '<div class="alert alert-success TOP">
        ...
        echo "<meta http-equiv='refresh' content='0.99'>";
            ...
            echo '<div class="alert alert-danger TOP">
            <strong>You must rate to submit!</strong> 
        </div>';
        echo "<meta http-equiv='refresh' content='0.99'>";
     }
