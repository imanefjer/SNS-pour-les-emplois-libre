...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in" style="width: 650px;">
      <h1>Je suis <?php echo $artisan['username']; ?></h1>
      <p style="font-size: 20px;"><?php echo $artisan['description']; ?> </p>
    </div>
  </section><!-- End Hero -->
